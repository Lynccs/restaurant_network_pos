...
func SetupAdminRoutes(r chi.Router, h *adminhandler.Handler, store sessions.Store) {
	r.Group(func(r chi.Router) {
		...
		r.Get("/admin/menu", h.MenuPage)
		r.Get("/admin/menu/new", h.MenuDishModal)
		r.Post("/admin/menu", h.MenuSaveDish)
		r.Get("/admin/menu/yield-alerts", h.MenuYieldAlertsModal)
		r.Post("/admin/menu/{id}/yield-price", h.MenuApplyYieldDiscount)
		r.Post("/admin/menu/{id}/restore-price", h.MenuRestorePrice)
		r.Get("/admin/menu/{id}/edit", h.MenuDishModal)
		r.Post("/admin/menu/{id}", h.MenuSaveDish)
		r.Delete("/admin/menu/{id}", h.MenuArchiveDish)
		r.Post("/admin/menu/{id}/unarchive", h.MenuUnarchiveDish)
		r.Post("/admin/menu/{id}/price", h.MenuUpdatePrice)
		r.Get("/admin/network/restaurants/new", h.NetworkRestaurantModal)
		r.Post("/admin/network/restaurants", h.NetworkCreateRestaurant)
		r.Get("/admin/network/restaurants/{id}/edit", h.NetworkRestaurantEditModal)
		r.Post("/admin/network/restaurants/{id}", h.NetworkUpdateRestaurant)
		...
		r.Delete("/admin/network/staff/{role}/{id}", h.NetworkDeleteStaff)
		r.Get("/admin/network/tables/{id}/edit", h.NetworkTableEditModal)
		r.Post("/admin/network/tables/{id}", h.NetworkUpdateTable)
		r.Delete("/admin/network/tables/{id}", h.NetworkDeleteTable)
		...
		r.Delete("/admin/suppliers/{id}", h.DeleteSupplierHandler)
		...
		r.Get("/admin/purchases/recommendations", h.GetPurchaseRecommendations)
		...
		r.Post("/admin/purchases/{id}/cancel", h.CancelOrder)
		...
		r.Delete("/admin/purchases/batches/{batchID}", h.DeleteBatch)
